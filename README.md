...
| [CI-CB/.../New-DODownloadModeBaseline.ps1](MECM/CI-CB/Configuration/DeliveryOptimization-DownloadMode/New-DODownloadModeBaseline.ps1) | Enforces Delivery Optimization `DODownloadMode` per OS class -- clients = 0, servers = 99. One CI + baseline each, deployed to separate collections. |
| [CI-CB/.../New-WDigestDisableBaseline.ps1](MECM/CI-CB/Hardening/WDigest-Disable/New-WDigestDisableBaseline.ps1) | Disables WDigest plaintext credential caching (`UseLogonCredential = 0`). Blocks Mimikatz cleartext recovery from LSASS. |
| [CI-CB/.../New-LSAProtectionBaseline.ps1](MECM/CI-CB/Hardening/LSA-Protection/New-LSAProtectionBaseline.ps1) | Enables LSA Protection (`RunAsPPL = 1`) so LSASS runs as a Protected Process Light. Reboot required to engage. |
| [CI-CB/.../New-NTLMHardeningBaseline.ps1](MECM/CI-CB/Hardening/NTLM-Hardening/New-NTLMHardeningBaseline.ps1) | Enforces NTLMv2-only authentication (`LmCompatibilityLevel = 5`; refuse LM & NTLMv1). |
| [CI-CB/.../New-SMBSigningBaseline.ps1](MECM/CI-CB/Hardening/SMB-Signing-Require/New-SMBSigningBaseline.ps1) | Requires SMB signing on client + server (`RequireSecuritySignature = 1`). Defeats SMB relay / MITM lateral movement. |
| [CI-CB/.../New-AnonymousEnumerationBaseline.ps1](MECM/CI-CB/Hardening/Anonymous-Enumeration-Restrict/New-AnonymousEnumerationBaseline.ps1) | Restricts anonymous / null-session enumeration (`RestrictAnonymous`, `RestrictAnonymousSAM`, `EveryoneIncludesAnonymous`). |
| [CI-CB/.../New-UACRemoteRestrictionBaseline.ps1](MECM/CI-CB/Compliance/UAC-Remote-Restriction/New-UACRemoteRestrictionBaseline.ps1) | Keeps UAC remote token filtering on (`LocalAccountTokenFilterPolicy = 0`). Blocks local-admin PtH lateral movement. |
| [CI-CB/.../New-NoElevatedInstallBaseline.ps1](MECM/CI-CB/Compliance/Installer-Elevated-Disable/New-NoElevatedInstallBaseline.ps1) | Disables Windows Installer `AlwaysInstallElevated` (HKLM = 0). Removes a local privilege-escalation primitive. |
| [CI-CB/.../New-ScriptBlockLoggingBaseline.ps1](MECM/CI-CB/Compliance/PowerShell-ScriptBlock-Logging/New-ScriptBlockLoggingBaseline.ps1) | Enables PowerShell script block logging (`EnableScriptBlockLogging = 1`, event 4104). Detective only. |
| [CI-CB/.../New-AutorunDisableBaseline.ps1](MECM/CI-CB/Compliance/Autorun-Disable/New-AutorunDisableBaseline.ps1) | Disables Autorun/Autoplay on all drive types (`NoDriveTypeAutoRun = 255`). |
| [CI-CB/.../New-RDPHardeningBaseline.ps1](MECM/CI-CB/Compliance/RDP-NLA-Encryption/New-RDPHardeningBaseline.ps1) | Requires RDP Network Level Authentication + TLS (`UserAuthentication = 1`, `SecurityLayer = 2`). |
